...
module.exports = class Trigger {
    constructor(serverless, deploy, initial) {
        ...
        this.create = {
            ...
            cr: this.provider.createCRTrigger.bind(this.provider),
        };
    }
    ...
    crId() {
        ...
        if (this.newState.params.registryId) {
            return this.newState.params.registryId;
        }
        return this.deploy.getContainerRegistryId(this.newState.params.registry);
    }
