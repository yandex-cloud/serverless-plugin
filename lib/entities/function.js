...
module.exports = class Function {
    ...
    async sync() {
        ...
        const requestParams = {
            ...
            code: this.serverless.service.package.artifact || this.newState.params.package.artifact,
        ...
        if(Object.keys(this.serverless.service.provider.environment).length){
            Object.assign(requestParams.environment, {...this.serverless.service.provider.environment})
        }
