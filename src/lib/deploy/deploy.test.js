...
beforeEach(() => {
    ...
    Object.entries(providerMock).forEach(([name, m]) => m.mockName(name));
...
test('deploy function with CR event', async () => {
    serverlessMock.service = {
        functions: {
            func1: {
                name: 'yc-nodejs-dev-func1',
...
test('deploy function with CR event and existing queue and existing registry', async () => {
    serverlessMock.service = {
        functions: {
            func1: {
                name: 'yc-nodejs-dev-func1',
